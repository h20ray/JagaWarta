...
<section aria-labelledby="related-heading" class="mx-auto max-w-wide-max border-t border-outline-variant mt-spacing-10 pt-spacing-10 px-spacing-4">
	...
	<div class="grid grid-cols-1 md:grid-cols-3 gap-spacing-5">
